{
  ...
  components: {
    ...
    "cert-manager": {
      acmeEmail: '985122724818-compute@developer.gserviceaccount.com',
    ...
    "iap-ingress": {
      ...
      hostname: 'kubeflow-app.endpoints.enel-dac-operations-devops.cloud.goog',
      ingressSetupImage: 'gcr.io/kubeflow-images-public/ingress-setup:latest',
      ipName: 'kubeflow-app-ip',
